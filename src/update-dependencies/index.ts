...
export function updateDependencies(): Rule {
  return chain([
    ...
    updateDep('@angular/animations', '14.2.6', addOrUpdate),
    updateDep('@angular/common', '14.2.6', addOrUpdate),
    updateDep('@angular/core', '14.2.6', addOrUpdate),
    updateDep('@angular/compiler', '14.2.6', addOrUpdate),
    updateDep('@angular/localize', '14.2.6', addOrUpdate),
    updateDep('@angular/forms', '14.2.6', addOrUpdate),
    updateDep('@angular/platform-browser', '14.2.6', addOrUpdate),
    updateDep('@angular/platform-browser-dynamic', '14.2.6', addOrUpdate),
    updateDep('@angular/router', '14.2.6', addOrUpdate),
    updateDep('@angular/cdk', '14.2.5', addOrUpdate),
    updateDep('@angular/material', '14.2.5', addOrUpdate),
    ...
    updateDevDep('@angular-eslint/builder', '14.1.2', updateIfExists),
    updateDevDep('@angular-eslint/eslint-plugin', '14.1.2', updateIfExists),
    updateDevDep('@angular-eslint/eslint-plugin-template', '14.1.2', updateIfExists),
    updateDevDep('@angular-eslint/schematics', '14.1.2', updateIfExists),
    updateDevDep('@angular-eslint/template-parser', '14.1.2', updateIfExists),
    ...
    updateDevDep('@angular-devkit/build-angular', '14.2.6', addOrUpdate),
    updateDevDep('@angular/compiler-cli', '14.2.6', addOrUpdate),
    updateDevDep('@angular/cli', '14.2.6', addOrUpdate),
    updateDevDep('@angular/language-service', '14.2.6', addOrUpdate),
    updateDevDep('@angular/elements', '14.2.6', addOrUpdate),
