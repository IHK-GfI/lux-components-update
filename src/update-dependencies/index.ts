...
export function updateDependencies(): Rule {
  return chain([
    ...
    updateDep('@ihk-gfi/lux-components-icons-and-fonts', '1.5.0', addOrUpdate),
    deleteDep('@ihk-gfi/lux-components-update'),
    updateDep('@angular/animations', '15.2.5', addOrUpdate),
    updateDep('@angular/common', '15.2.5', addOrUpdate),
    updateDep('@angular/core', '15.2.5', addOrUpdate),
    updateDep('@angular/compiler', '15.2.5', addOrUpdate),
    updateDep('@angular/localize', '15.2.5', addOrUpdate),
    updateDep('@angular/forms', '15.2.5', addOrUpdate),
    updateDep('@angular/platform-browser', '15.2.5', addOrUpdate),
    updateDep('@angular/platform-browser-dynamic', '15.2.5', addOrUpdate),
    updateDep('@angular/router', '15.2.5', addOrUpdate),
    ...
    updateDevDep('@typescript-eslint/eslint-plugin', '5.43.0', updateIfExists),
    updateDevDep('@typescript-eslint/parser', '5.43.0', updateIfExists),
    ...
    updateDevDep('@angular-devkit/build-angular', '15.2.4', addOrUpdate),
    updateDevDep('@angular/compiler-cli', '15.2.5', addOrUpdate),
    updateDevDep('@angular/cli', '15.2.4', addOrUpdate),
    updateDevDep('@angular/language-service', '15.2.5', addOrUpdate),
    updateDevDep('@angular/elements', '15.2.5', addOrUpdate),
