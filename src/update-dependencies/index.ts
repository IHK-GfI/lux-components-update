  ...
  return (tree: Tree, context: SchematicContext) => {
    return waitForTreeCallback(tree, () => {
      const dependencies: NodeDependency[] = [
        ...
        { type: NodeDependencyType.Default, version: '10.1.1', name: '@angular/animations' },
        { type: NodeDependencyType.Default, version: '10.1.1', name: '@angular/common' },
        { type: NodeDependencyType.Default, version: '10.1.1', name: '@angular/core' },
        { type: NodeDependencyType.Default, version: '10.1.1', name: '@angular/compiler' },
        { type: NodeDependencyType.Default, version: '10.0.0-beta.32', name: '@angular/flex-layout' },
        { type: NodeDependencyType.Default, version: '10.1.1', name: '@angular/forms' },
        { type: NodeDependencyType.Default, version: '10.1.1', name: '@angular/platform-browser' },
        { type: NodeDependencyType.Default, version: '10.1.1', name: '@angular/platform-browser-dynamic' },
        { type: NodeDependencyType.Default, version: '10.1.1', name: '@angular/router' },
        { type: NodeDependencyType.Default, version: '10.2.0', name: '@angular/cdk' },
        { type: NodeDependencyType.Default, version: '10.2.0', name: '@angular/material' },
        ...
        { type: NodeDependencyType.Default, version: '2.4.456', name: 'pdfjs-dist' }
      ];
  ...
  return (tree: Tree, context: SchematicContext) => {
    return waitForTreeCallback(tree, () => {
      const devDependencies: NodeDependency[] = [
        { type: NodeDependencyType.Dev, version: '0.1000.8', name: '@angular-devkit/build-angular' },
        { type: NodeDependencyType.Dev, version: '10.1.1', name: '@angular/compiler-cli' },
        { type: NodeDependencyType.Dev, version: '10.1.0', name: '@angular/cli' },
        { type: NodeDependencyType.Dev, version: '10.1.1', name: '@angular/language-service' },
